...
class RecordCollection(GeoInterfaced):
    ...
    def get(self, max_depth=None):
        """Get |Record| and optionally cap their :attr:`~plums.commons.data.record.Record.labels` to a maximum depth.

        See Also:
            The label :meth:`~plums.commons.data.record.Record.get_labels` method which handles the heavy lifting.
