...
class Path(PathLike):
    ...
    @property
    def _stat(self):
        """:class:`~plums.commons.path._Stat`: ``self`` corresponding  :class:`~plums.commons.path._Stat` object."""
    ...
    def walk(self, topdown=True, onerror=None, followlinks=False):
        ...
        Yields:
            (:class:`~plums.commons.Path` , [:class:`~plums.commons.Path`], [:class:`~plums.commons.Path`]):
