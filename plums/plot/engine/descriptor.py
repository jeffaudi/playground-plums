...
class Labels(CategoricalDescriptor):
    """A |Descriptor| used to extract a categorical property from :attr:`~plums.commons.data.record.Record.labels`."""
...
class Confidence(ContinuousDescriptor):
    """A |Descriptor| used to extract a continuous property from :attr:`~plums.commons.data.record.Record.confidence`.
...
class IntervalConfidence(IntervalDescriptor):
    """A |Descriptor| used to extract a interval property from :attr:`~plums.commons.data.record.Record.confidence`.
...
class Area(ContinuousDescriptor):
    """A |Descriptor| used to extract an area property from :attr:`~plums.commons.data.record.Record.coordinates`.
