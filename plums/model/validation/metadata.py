...
class Model(MetadataComponent):
    ...
    Schema:
        ...
        initialisation (:class:`~plums.model.validation.metadata.Initialisation`): The |Model| initialisation section.
        training (:class:`~plums.model.validation.metadata.Training`): The |Model| training section.
        configuration (:class:`~plums.model.validation.metadata.Configuration`): The |Model| configuration section.
...
class Training(MetadataComponent):
    ...
    Schema:
        ...
        latest (:class:`str`, :class:`int`): A reference to the latest registered |Checkpoint| in the |CheckpointSchema|
            section.
        checkpoint (:class:`~plums.model.validation.metadata.Configuration`): The |Training| checkpoints section.
