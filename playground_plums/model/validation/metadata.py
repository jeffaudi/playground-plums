...
from playground_plums.model.exception import PlumsValidationError, PlumsModelMetadataValidationError
from playground_plums.model.validation.schema_core import SchemaComponent, Path, MD5Checksum, Default
...
class Metadata(MetadataComponent):
    ...
    Schema:
        format (:class:`~playground_plums.model.validation.metadata.Format`): The format metadata section.
        model (:class:`~playground_plums.model.validation.metadata.Model`): The model metadata section.
...
class Configuration(MetadataComponent):
    ...
    Schema:
        path (:class:`~playground_plums.model.validation.schema_core.Path`): The configuration file path.
        hash (:class:`~playground_plums.model.validation.schema_core.MD5Checksum`): The configuration file checksum.
...
class InitialisationPMF(MetadataComponent):
    ...
    Schema:
        ...
        path (:class:`~playground_plums.model.validation.schema_core.Path`): The initialisation |Model| location.
...
class InitialisationPath(MetadataComponent):
    ...
    Schema:
        ...
        path (:class:`~playground_plums.model.validation.schema_core.Path`): The initialisation file path.
        hash (:class:`~playground_plums.model.validation.schema_core.MD5Checksum`): The initialisation file checksum.
...
class Model(MetadataComponent):
    ...
    Schema:
        ...
        initialisation (:class:`~playground_plums.model.validation.metadata.Initialisation`):
            The |Model| initialisation section.
        training (:class:`~playground_plums.model.validation.metadata.Training`):
            The |Model| training section.
        configuration (:class:`~playground_plums.model.validation.metadata.Configuration`):
...
class Checkpoint(DefaultMetadata):
    ...
    *checkpoint* schema:
    ...
    Schema:
        ...
        path (:class:`~playground_plums.model.validation.schema_core.Path`): The |Checkpoint| file path.
        hash (:class:`~playground_plums.model.validation.schema_core.MD5Checksum`): The |Checkpoint| file checksum.
...
class Training(MetadataComponent):
    ...
    Schema:
        ...
        latest (:class:`str`, :class:`int`): A reference to the latest registered |Checkpoint| in the |CheckpointSchema|
            section.
        checkpoint (:class:`~playground_plums.model.validation.metadata.Configuration`):
...
class Producer(MetadataComponent):
    ...
    Schema:
        ...
        version (:class:`~playground_plums.model.validation.metadata.ProducerVersion`): The |Producer| version section.
...
class Format(MetadataComponent):
    ...
    Schema:
        ...
        version (:class:`~playground_plums.model.validation.metadata.Producer`): The format producer section.
