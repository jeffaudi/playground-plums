...
from playground_plums.model.validation.metadata import Training as TrainingMetadata
from playground_plums.model.components.version import version
from playground_plums.model.components.utils import TrainingStatus, Checkpoint, is_duplicate
...
class CheckpointCollection(object):
    ...
    def values(self):
        ...
        Yields:
            :class:`~playground_plums.model.components.utils.Checkpoint`: A |Checkpoint|.
    ...
    def items(self):
        ...
        Yields:
            (hashable, :class:`~playground_plums.model.components.utils.Checkpoint`): Reference and |Checkpoint|.
