...
from playground_plums.plot.engine.utils import dict_equal
from playground_plums.plot.engine.color import Color
from playground_plums.plot.engine.color.color_map import ColorMap, identity
...
class Labels(CategoricalDescriptor):
    """Extract a categorical property from :attr:`~playground_plums.commons.data.record.Record.labels`."""
...
class Confidence(ContinuousDescriptor):
    """Extract a continuous property from :attr:`~playground_plums.commons.data.record.Record.confidence`.
...
class IntervalConfidence(IntervalDescriptor):
    """Extract a interval property from :attr:`~playground_plums.commons.data.record.Record.confidence`.
...
class Area(ContinuousDescriptor):
    """Extract an area property from :attr:`~playground_plums.commons.data.record.Record.coordinates`.
