    ...
    def __call__(self, array, keep_colors=False):
        ...
        Args:
            ...
            keep_colors (bool): Optional. Default to ``False``. If ``True``, returns an array of |Color|, otherwise, an
                :class:`~np.ndarray` of :attr:`~playground_plums.plot.color.color.Color.components` is returned.

        Returns:
            :class:`~numpy.ndarray`: An array of |Color| or :attr:`~playground_plums.plot.color.color.Color.components`
