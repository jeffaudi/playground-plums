...
class RecordCollection(GeoInterfaced):
    ...
    def get(self, max_depth=None):
        """Get |Record| and cap their :attr:`~playground_plums.commons.data.record.Record.labels` to a maximum depth.

        See Also:
            The label :meth:`~playground_plums.commons.data.record.Record.get_labels` method which handles the lifting.
