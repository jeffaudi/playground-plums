...
class TreeIteratorBase(object, metaclass=abc.ABCMeta):
    ...
    def __iter__(self):
        ...
        Yields (:class:`~playground_plums.commons.Label`, Iterable[:class:`~playground_plums.commons.Label`]):
...
class DefaultTreeIterator(TreeIteratorBase):
    ...
    def __iter__(self):
        ...
        Yields (:class:`~playground_plums.commons.Label`): A tree |Label| node.
    ...
    def depth_wise_top_down(self):
        ...
        Yields (Iterable[:class:`~playground_plums.commons.Label`]): An iterator over an ensemble of |Label| nodes.
