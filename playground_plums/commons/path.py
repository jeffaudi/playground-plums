...
class Path(PathLike):
    ...
    @property
    def _stat(self):
        """:class:`~playground_plums.commons.path._Stat`: ``self`` corresponding object."""
    ...
    def listdir(self):
        ...
        Yields:
            :class:`~playground_plums.commons.Path`: Each element found in |Path|.
    ...
    def walk(self, topdown=True, onerror=None, followlinks=False):
        ...
        Yields:
            (:class:`~playground_plums.commons.Path` , [:class:`~playground_plums.commons.Path`],
            [:class:`~playground_plums.commons.Path`]):
    ...
    def glob(self, pattern):
        ...
        Yields:
            :class:`~playground_plums.commons.Path`: Matching files.
